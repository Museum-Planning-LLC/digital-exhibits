...
Use only **after** a Resiliency Planning Study, when footprint analysis supports digital work in a named zone. Do not use in cold outreach or homepage hero.
...
- Experience specification aligned to study spatial baseline
- Content structure and media plan (institution archives / subject matter)
- Install specification: hardware, shell, sensing (as required), offline operation
- Commissioning, staff orientation, and handoff documentation
...
**Sequence:** Fund after [footprint / reactivation menu item # — insert dependency]
